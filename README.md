...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Анализ_рынка_видеоигр)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Оператор_мобильной_связи_рекомендация_тарифов)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/История_TED_конференций)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Прогноз_удоя_коров_и_вкуса_молока)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Удержание_активности_постоянных_покупателей)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/HR_аналитика)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Модель_для_золотодобывающей_отрасли)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Выбор_локации_для_скважины)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Определение_стоимости_автомобиля)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Предсказание_количества_заказов_такси_на_следующий_час)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Поиск_токсичных_комментариев)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Определение_возраста_покупателей_по_фото)
...
[Ссылка на проект](https://github.com/LyudmilaN-3/Practicum_DS_projects/Предсказание_температуры_сплава_стали)
